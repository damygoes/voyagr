...
export function AuthLayout({
  ...
  return (
    <main className="flex flex-col md:flex-row h-screen w-full bg-background">
      {/* Left Section with Background Image */}
      <section
        className="relative flex-1 flex items-center justify-center px-lg py-2xl md:px-xl text-center bg-cover bg-center bg-no-repeat text-white"
        style={{ backgroundImage: "url('/images/auth-bg.jpg')" }}
        aria-labelledby="auth-title"
      >
        <div className="absolute inset-[0px] bg-[#000] opacity-50 z-0" />
